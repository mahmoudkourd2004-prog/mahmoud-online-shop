...
if (document.querySelector(".slide-swap")) {
...
function updateCart() {
        ...
        <div class="item_cart">
          ...
          <div class="content">
            ...
            <div class="quantity_control">
              <button class="decreace_quantity" data-index=${index}>-</button>
              <span class="quantity">${item.quantity}</span>
              <button class="increase_quantity" data-index=${index}>+</button>
            </div>
          </div>
          <button class="delete_item" data-inex="${index}">
  ...
  const decreaseButtons = document.querySelectorAll(".decreace_quantity");
...
function displayCheckoutItems() {
  let checkoutContainer = document.getElementById("checkout_items");
      ...
      <div class="item_cart">
        <div class="image_name">
          ...
          <div class="content">
            ...
            <div class="quantity_control">
              <button onclick="decreaseQuantityCheckout(${index})">-</button>
              <span class="quantity">${item.quantity}</span>
              <button onclick="increaseQuantityCheckout(${index})">+</button>
            </div>
          </div>
        </div>

        <button onclick="deleteItemCheckout(${index})" class="delete_item">
          <i class="fa-solid fa-trash-can"></i>
        </button>
      </div>
    `;
  ...
  let subtotalElement = document.querySelector(".subtotal_checkout");
  let totalElement = document.querySelector(".total_checkout");
...
function increaseQuantityCheckout(index) {
  let cart = JSON.parse(localStorage.getItem("cart")) || [];
  cart[index].quantity++;
  localStorage.setItem("cart", JSON.stringify(cart));
...
function decreaseQuantityCheckout(index) {
  let cart = JSON.parse(localStorage.getItem("cart")) || [];
...
function deleteItemCheckout(index) {
  let cart = JSON.parse(localStorage.getItem("cart")) || [];
...
const elements = document.querySelectorAll(".banners, .banner-4");
